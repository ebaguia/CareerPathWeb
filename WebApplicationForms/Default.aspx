...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        <h2>Kia Ora!</h2>
        <p class="lead">Please use this application to guide you in identifying the courses to be taken in order to have a career in Electrical and Computer Engineering.</p>
    ...
    <div class="row">
        <div class="col-md-4">
            <h2>Careers</h2>
            <p>
                What are the possible careers that you will work on once you graduate from the Electrical and Computer Engineering department?
            </p>
            <p>
